...
import me.andy.mvvmhabit.base.BaseViewModel.ParameterField;
import me.andy.mvvmhabit.bus.Messenger;
import me.andy.mvvmhabit.util.DialogUtil;
import me.andy.mvvmhabit.util.MaterialDialogUtils;
import me.andy.mvvmhabit.util.StatusBarUtil;
...
public abstract class BaseActivity<V extends ViewDataBinding, VM extends BaseViewModel> extends RxAppCompatActivity implements IBaseView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switch (getClass().getName()) {
            case "com.yunhuakeji.model_launch.activity.LaunchActivity":
                StatusBarUtil.immersive(this.getWindow());
                break;
            case "com.yunhuakeji.model_main.ui.MainTabActivity":
                break;
            default:
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    StatusBarUtil.setColor(this, ContextCompat.getColor(this, R.color.white), 0);//设置标题栏颜色
                    StatusBarUtil.darkModeForM(getWindow(), true);
                }
                break;
        }
//        if (!"com.yunhuakeji.model_main.ui.MainTabActivity".equals(getClass().getName())) {
//            //android6.0以后支持沉浸式状态栏
//
//        }
...
//        DialogUtil.getInstance().showDialog(this,title);
    }
