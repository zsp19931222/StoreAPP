package me.andy.mvvmhabit.binding.viewadapter.view;
...
import me.andy.mvvmhabit.binding.command.BindingCommand;
...
public class ViewAdapter {
    ...
    public static void isTVColor(TextView view, final int color) {
